...
public interface PendingRequestService {
     ...
     * </p>
     *
     * @param page Page number that to be fetched
     * @param size No of rows that are to be displayed in a page
     ...
     */
    Optional<PendingRequest> findRequestByMobileNumber(String mobileNumber);
}
